...
__DEFINE__(1659423938079, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1659423938080,"./event-store":1659423938081}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1659423938080, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1659423938081, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1659423938080,"./utils":1659423938082}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1659423938082, function(require, module, exports) {
...
return __REQUIRE__(1659423938079);
})()
